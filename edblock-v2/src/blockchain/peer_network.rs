...
pub struct Node {
    ...
    msg_incoming_tx: tokio::sync::broadcast::Sender<String>,
...
impl Node {
    pub async fn new(port: u32) -> Node {
        ...
        let (msg_incoming_tx, _) = tokio::sync::broadcast::channel::<String>(100);
    ...
    pub fn take_reciever(&mut self) -> tokio::sync::broadcast::Receiver<String> {
        self.msg_incoming_tx.subscribe()
    }
